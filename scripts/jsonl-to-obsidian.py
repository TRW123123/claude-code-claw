...
# --- Konfiguration ---
PROJECTS_DIR = Path(r"~/.claude/projects")
VAULT_DIR = Path(r"~/obsidian-vault")
...
def process_chatgpt_exports(concept_backrefs):
 """Parse ~/Projects/Chats\\clean_exports\\chat_export_part_*.txt
 ...
 """
 src_dir = Path(r"~/Projects/Chats\clean_exports")
...
def process_projects_folder(concept_backrefs):
 """Walk ~/Projects recursively, copy relevant .md files into
...
def main():
 ...
 print("\n[Phase 3] Processing Projects folder (~/Projects)...")
