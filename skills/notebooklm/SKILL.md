...
**AUTH:** Gehe davon aus dass der Login persistent und aktiv ist (Sessions halten Wochen). Frag NIEMALS proaktiv nach `notebooklm login`. Führe Login erst durch wenn du einen expliziten Authentifizierungsfehler bekommst (Session Expired / Unauthorized / Redirected to accounts.google.com).

**ENCODING:** Immer `PYTHONUTF8=1 PYTHONIOENCODING=utf-8` vor allen notebooklm Befehlen setzen.
